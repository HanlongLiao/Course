...
def getFirstImprovement(sol, action_list, distance):  # 得到改进解
    ...
    while True:
        ...
        for action in action_list:
            ...
            if tour_len < current_len:
                current_sol = sol_new.copy()
                current_len = get_tour_length(current_sol, distance)
                temp = 1
                break
        if temp == 0:
...
# print(action_list)
new_sol = getFirstImprovement(sol, action_list, distance)
