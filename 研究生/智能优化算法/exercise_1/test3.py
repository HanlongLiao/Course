...
MaxIt = 448 # 最大迭代次数
# TC = np.zeros(nAction)  # 初始化禁忌表
TC = pd.Series([0 for i in range(nAction)], index=[str(action) for action in ActionList])
